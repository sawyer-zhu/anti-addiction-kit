...
//                }
            ...
            if(num > AntiAddictionKit.getCommonConfig().getYoungPayLimit()){
                strictType = 1;
                desc = AntiAddictionKit.getCommonConfig().strPayLimitYoung;
            }else{
