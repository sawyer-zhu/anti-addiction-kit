...
SWIFT_CLASS("_TtC16AntiAddictionKit4HTTP")
...
@interface HTTP (SWIFT_EXTENSION(AntiAddictionKit)) <NSURLSessionDataDelegate>
...
SWIFT_CLASS("_TtC16AntiAddictionKit10HTTPResult")
